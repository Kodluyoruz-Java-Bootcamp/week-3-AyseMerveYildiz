...
public class UserController {
	...
	public User getSearches(@PathVariable String search) {
		System.out.println("arama " + search);
		System.out.println("getSearches - userService :: " + service);
		return service.getByEmail(search);
	}
	@PostMapping
	// @ResponseStatus(code = HttpStatus.CREATED)
	public ResponseEntity<User> saveSearch(@RequestBody User search) {
		service.saveSearch(search);
		System.out.println("saveSearch :: " + service);
