...
public class UserService {
	...
	public void saveSearch(User search) {
		System.out.println("ben bir userDao objesiyim:" + userRepository.toString());
		userRepository.createUser(search);
		System.out.println("[saveSearch] arama kaydedildi :: " + search);
	}
	...
	public User getSearches(String search) {

		//// @formatter:off
		return userRepository.findAllSearches()
				.stream()
				.filter(user -> user.getSearches().equals(search))
				.findFirst()
				.get();
		// @formatter:on
